...
**Repo:** [github.com/nzrfrz/it-infra-local-java-air-craft-monitoring](https://github.com/nzrfrz/it-infra-local-java-air-craft-monitoring), backend/pipeline (`src/`, `api/`) + frontend `it-infra-web` di-subtree ke `web/`

**Anggota kelompok:**

| Nama | NIM |
|---|---|
| Mahendra Bayu Prayoga | 25.51.1778 |
| Bagas Restya Ermawan | 25.51.1779 |
| Akmal Rafi Fadhillah | 25.51.1810 |
| Muhammad Abiyyu Rahman | 25.51.1738 |
| Moh Nizar Farizi | 25.51.1805 |
